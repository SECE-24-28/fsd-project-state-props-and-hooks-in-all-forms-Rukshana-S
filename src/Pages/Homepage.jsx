...
const brands = [
  { img: b1, name: "Yousta", desc: "Youthful pastel essentials" },
  { img: b2, name: "Azorte", desc: "Contemporary luxury wear" },
  { img: b3, name: "Biba", desc: "Timeless ethnic elegance" },
  { img: b4, name: "Manyavar", desc: "Festive & bridal couture" },
];
    ...
    <main id="app-viewport">
      <div className="view-container">
        ...
        <section className="container" style={{ marginBottom: "70px" }}>
          <div className="section-header">
            <div className="section-title-wrap">
              <h2 className="section-title">Refined Brand Showcase</h2>
              <p className="section-desc">Discover India's most loved fashion labels.</p>
            </div>
          </div>
          <div className="brands-grid">
            {brands.map((b, i) => (
              <div key={i} className="brand-card" onClick={() => goTo("/products")}>
