...
export default function ResetPassword() {
  ...
  const resetEmail = localStorage.getItem("wearly_reset_email");
  ...
  const handleSubmit = (e) => {
    ...
    if (stored && stored.email === resetEmail) {
      localStorage.setItem("wearly_registered_user", JSON.stringify({ ...stored, password: form.password }));
      localStorage.removeItem("wearly_reset_email");
      setDone(true);
